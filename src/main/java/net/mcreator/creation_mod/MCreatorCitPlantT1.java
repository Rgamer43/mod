...
public class MCreatorCitPlantT1 extends Elementscreation_mod.ModElement {
	@ObjectHolder("creation_mod:citplantt1")
	public static final Block block = null;

	public MCreatorCitPlantT1(Elementscreation_mod instance) {
		super(instance, 8);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorCitChunkT1.block, (int) (3)));
		}
