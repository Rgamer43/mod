...
public class MCreatorMortarandPestleT1GUI extends Elementscreation_mod.ModElement {
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;
	private static ContainerType<GuiContainerMod> containerType = null;

	public MCreatorMortarandPestleT1GUI(Elementscreation_mod instance) {
		super(instance, 4);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("mortarandpestlet1gui"));
	}
	...
	public static class GuiContainerMod extends Container {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				creation_mod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("creation_mod:textures/mortarandpestlet1gui.png");
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 115, this.guiTop + 38, 50, 20, "Grind", e -> {
				creation_mod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
